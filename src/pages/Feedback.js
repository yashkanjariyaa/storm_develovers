...
export default function Feedback() {
  ...
  return (
    ...
    <div className='main_div' style={containerStyle}>
        ...
        <Label >Problems with Bathrooms/Washrooms(If none, write 'none'):</Label>
        <StyledInput1 placeholder="Write your problems here" />
        <HelperText />
        </FormControl>
        <br/>
        <FormControl defaultValue='' required>
            <Label >Any problems with your Hygiene of offices'(If none, write 'none'):</Label>
...
const StyledInput2 = styled(Input)(
  ...
  `,
    ...
    `;
        ...
        return showRequiredError ? <p {...props} style={{color:'greenyellow'}}>This field is required.</p> : null;
        })`
        font-family: 'IBM Plex Sans', sans-serif;
        font-size: 0.875rem;
        `;
